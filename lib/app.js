var app = (function() {
  ...
  function init(opt_notes) {
    model.init(opt_notes || debug_load(), noteList.updateNote);

    ui.editor.init($('#editor'), model.updateNote);
    ui.searchBox.init($('#search'), onSearch);
    noteList.init($('#noteList'), ui.editor.setNote);
  ...
  function createNote(title) {
    ...
    // This will trigger model observer.
  }
